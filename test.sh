...
echo -e "\n#-----------------#\n#test 1 => ref 60 \n##"
ARG="60"; ./bin/push_swap $ARG | ./checker_linux $ARG

echo -e "\n#-----------------#\n#TEST COM DOIS VALORES\n##"

echo -e "\n#-----------------#\n#test 1 => ref 60 50 \n##"
ARG="60 50"; ./bin/push_swap $ARG | ./checker_linux $ARG

echo -e "\n#-----------------#\n#test 2 => ref 50 60 \n##"
ARG="50 60"; ./bin/push_swap $ARG | ./checker_linux $ARG
...
echo -e "\n#-----------------#\n#test 1 => ref 2 1 5 4 \n##"
ARG="2 1 5 4"; ./bin/push_swap $ARG | ./checker_linux $ARG

echo -e "\n#-----------------#\n#test 2 => ref 0 1 5 4 \n##"
ARG="0 1 5 4"; ./bin/push_swap $ARG | ./checker_linux $ARG

echo -e "\n#-----------------#\n#test 3 => ref 4 1 5 6 \n##"
ARG="4 1 5 6"; ./bin/push_swap $ARG | ./checker_linux $ARG
